...
public class InterceptingFilter implements Filter {
    ...
    static {
        ...
        // Software/Crypto Inventory moved under IT Operations; permission now follows 'operations'.
        SERVICE_MODULE_MAP.put("supplychain", "operations");
        SERVICE_MODULE_MAP.put("data",        "data");
        SERVICE_MODULE_MAP.put("dataflows",   "data");
    }
    ...
    public void init(FilterConfig filterConfig) throws ServletException {
        ...
        System.out.println("TSI Compass service started in " + System.getenv("TSI_COMPASS_ENV") + " environment");
    }

    private void executeAction(String className, HttpServletRequest req, HttpServletResponse res) throws ServletException {
        try {
            Action action = (Action) Class.forName(className).getConstructor().newInstance();
            action.post(req, res);
        } catch (ReflectiveOperationException | ClassCastException e) {
            throw new ServletException("Unable to load action: " + className, e);
        }
    }
}
